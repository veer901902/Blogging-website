...
import {SignupInput} from "@veer901902/medium-common"
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    {type === "signup" ? <LabelledInput label="Name" placeholder="Veer Bahadur Singh" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            username: e.target.value
                        })
                    }} /> : null}
                    <LabelledInput label="Email" placeholder="veer@gmail.com" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
